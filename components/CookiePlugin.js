class CookiePlugin extends React.Component {
  ...
  declineCookies() {
    Cookies.set( 'declineCookies', false );
    this.setState({
      visible: false
    })
  }
      ...
      <div class="CookieBanner container fixed-bottom alert alert-light border alert-dismissible fade show" role="alert" ref="cookieBanner">
        <div class="row justify-content-between align-items-stretch">
          ...
          <div class="col-8">
            ...
            <p class="lh-base fs-6 m-0">Cookies let us give you a better experience and improve our products.<br /> We won't turn them until you accept.</p>
          </div>
          <div class="col-2">
            <div class="row">
